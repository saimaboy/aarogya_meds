              ...
              children: [
                  ...
                  children: [
                    Row(
                        ...
                        [
                          ...
                          const Icon(Icons.star, color: Colors.amber, size: 18),
                          const Icon(
                              Icons.star_half_outlined, color: Colors.amber,
                              size: 18),
                        ]),
                    const Text("(3500)", style: TextStyle(
                        fontSize: 14, fontWeight: FontWeight.w600),),
                  ],
                ),
                ...
                Row(
                  children: [
                    const Expanded(
                      flex: 2,
                      child: Text("Time To Travel", style: TextStyle(
                    ...
                    const Expanded(
                        flex: 2,
                        child: Text("22 min", style: TextStyle(
                            fontSize: 15, fontWeight: FontWeight.w600),)
                    ),
                  ],
                ),
                            ...
                            children: [
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: const Center(
                                    child: Icon(
                                        Icons.share, color: AppColors.white),
                                  ),
                                ),
                              ),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left: 8.0),
                      child: Text("open at $openTime ", style: const TextStyle(
                          fontSize: 14, fontWeight: FontWeight.w500)),
                    ),
                  ],
                ),
