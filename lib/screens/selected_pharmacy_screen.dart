          ...
          children: [
            ...
            Row(
              children: [
                ...
                [
                  ...
                  const Icon(Icons.star, color: Colors.amber,size: 18),
                  const Icon(Icons.star, color: Colors.amber,size: 18),
                  const Icon(Icons.star_half_outlined, color: Colors.amber,size: 18),
                ]),
                const Text("(3500)",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600),),
              ],
            ),
            ...
            Row(
              children: [
                const Expanded(
                  flex: 2,
                    child: Text("Time To Travel",style: TextStyle(fontSize:15,fontWeight: FontWeight.w600),),
                ),
                SizedBox(width: size.width*0.3,),
                const Icon(Icons.time_to_leave),
                const Expanded(
                  flex: 2,
                    child: Text("22 min",style: TextStyle(fontSize:15,fontWeight: FontWeight.w600),)
                ),
              ],
            ),
            SizedBox(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image:const DecorationImage(image: AssetImage("lib/assets/images/pharmacy_2.jpeg"),fit:BoxFit.fill),
                        ...
                        children: [
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Center(
                                child: Icon(Icons.directions_rounded,color:iconColor),
                              ),
                            ),
                          ),
                          const Text("Directions",style:TextStyle(fontSize: 13,fontWeight: FontWeight.w500)),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: InkWell(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Text("Call",style:TextStyle(fontSize: 13,fontWeight: FontWeight.w500)),
                        ],
                      ),
                    ),
                  ),
                        ...
                        children: [
                          Container(
                            ...
                            child: Padding(
                              padding: EdgeInsets.all(size.width*0.02),
                              child: const Center(
                                child: Icon(Icons.bookmark_border_outlined,color:AppColors.white),
                              ),
                            ),
                          ),
                    ...
                    child: InkWell(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Text("Share",style:TextStyle(fontSize: 13,fontWeight: FontWeight.w500)),
                        ],
                      ),
                    ),
                  ),
            ...
            Row(
              children: [
                ...
                Padding(
                  ...
                  child: Text(location,style: const TextStyle(fontSize: 14,fontWeight: FontWeight.w500),),
                ),
              ],
            ),
            const Divider(
            ...
            Row(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(left:8.0),
                  child: Text("open at $openTime ",style: const TextStyle(fontSize: 14,fontWeight: FontWeight.w500)),
                ),
              ],
            ),
            const Divider(
